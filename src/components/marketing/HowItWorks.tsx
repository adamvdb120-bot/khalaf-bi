...
const steps = [
  {
    ...
    desc: "Wij koppelen je Exact Online, kassasysteem of andere bronsystemen. Geen technische kennis nodig — wij regelen alles.",
    color: "bg-blue-50 text-blue-600",
  },
  {
    icon: LayoutDashboard,
    step: "02",
    title: "Je dashboard gaat live",
    desc: "Binnen 48 uur zie je alle KPI's op één overzichtelijk scherm. Realtime bijgewerkt, altijd actueel, op elk apparaat.",
  ...
  },
  {
    ...
    desc: "Elke maand ontvang je automatisch een rapport in je inbox. En als er iets opvallends is, krijg je direct een melding.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">
            ...
            helder inzicht in je bedrijfscijfers.
          </p>
        </div>
